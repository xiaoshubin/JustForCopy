...
class SignActivity : BaseBindActivity<ActivitySignBinding>() {
    ...
    fun checkPermission() {
        if (XXPermissions.isGrantedPermission(this, Permission.MANAGE_EXTERNAL_STORAGE)) {
            ...
            Log.e("TAG","没有读写权限,去申请")
            XXPermissions.with(this)
                .permission(Permission.MANAGE_EXTERNAL_STORAGE)
                .request(object : OnPermissionCallback {
                    override fun onGranted(permissions: MutableList<String>?, all: Boolean) {
                        if (all) {
                            Log.e("TAG","获取文件读写权限成功")
                            saveImg()
...
//            .sub({
//                Log.e("TAG","上传成功${it.data}")//上传成功UploadImgBean(cmpImgName=null, cmpImgUrl=null, imgName=sign_1622719280612.jpg, imgUrl=upload/2021-06/2b99b3a4058940f39e37e89602cc1691.jpg)
//                val intent = Intent()
